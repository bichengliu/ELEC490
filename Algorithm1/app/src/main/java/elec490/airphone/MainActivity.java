...
public class MainActivity extends AppCompatActivity {
        ...
        switch (view.getId()) {
            case R.id.radio_low:
                if (checked) {
                    ...
                    //audioOutput(audio);
                    //}
                    decision = algorithm(data, lowThresh);
                    output = Integer.toString(decision);

                    ((TextView) findViewById(R.id.button_reply)).setText(output);
                }
                break;
            ...
            case R.id.radio_medium:
                if (checked) {
                    ...
                    decision = algorithm(data, mediumThresh);
                    output = Integer.toString(decision);
            ...
            case R.id.radio_high:
                if(checked) {
                    ...
                    decision = algorithm(data, highThresh);
                    output = Integer.toString(decision);
    ...
    public native int algorithm(double data[], double alpha);
