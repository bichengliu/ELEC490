...
final class Request {
    ...
    public static abstract class Body {
        ...
        static class C00011 extends Body {
            final /* synthetic */ byte[] val$content;
            final /* synthetic */ MediaType val$contentType;

            C00011(MediaType mediaType, byte[] bArr) {
        ...
        static class C00102 extends Body {
            final /* synthetic */ MediaType val$contentType;
            final /* synthetic */ File val$file;

            C00102(MediaType mediaType, File file) {
                this.val$contentType = mediaType;
                this.val$file = file;
            }
        ...
        public static Body create(MediaType contentType, byte[] content) {
            if (contentType == null) {
                ...
                return new C00011(contentType, content);
            } else {
        ...
        public static Body create(MediaType contentType, File file) {
            if (contentType == null) {
                ...
                return new C00102(contentType, file);
            } else {
                throw new NullPointerException("content == null");
            }
        }
