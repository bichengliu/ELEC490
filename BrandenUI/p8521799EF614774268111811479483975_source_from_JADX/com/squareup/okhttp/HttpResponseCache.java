...
public final class HttpResponseCache extends ResponseCache {
    ...
    private final class CacheRequestImpl extends CacheRequest {
        ...
        class C00071 extends FilterOutputStream {
            final /* synthetic */ Editor val$editor;
            final /* synthetic */ HttpResponseCache val$this$0;

            C00071(OutputStream x0, HttpResponseCache httpResponseCache, Editor editor) {
        ...
        public CacheRequestImpl(Editor editor) throws IOException {
            ...
            this.body = new C00071(this.cacheOut, HttpResponseCache.this, editor);
        }
    ...
    class C00021 implements OkResponseCache {
        C00021() {
        }
    ...
    static class C00062 extends FilterInputStream {
        final /* synthetic */ Snapshot val$snapshot;

        C00062(InputStream x0, Snapshot snapshot) {
        ...
        private void writeCertArray(Writer writer, Certificate[] certificates) throws IOException {
            ...
            try {
                ...
                for (int i = HttpResponseCache.ENTRY_METADATA; i < length; i += HttpResponseCache.ENTRY_BODY) {
                    writer.write(Base64.encode(certificates[i].getEncoded()) + '\n');
                }
    ...
    public HttpResponseCache(File directory, long maxSize) throws IOException {
        this.okResponseCache = new C00021();
    ...
    private synchronized void trackResponse(ResponseSource source) {
        ...
        switch (C00043.$SwitchMap$com$squareup$okhttp$ResponseSource[source.ordinal()]) {
            case ENTRY_BODY /*1*/:
    ...
    private static InputStream newBodyInputStream(Snapshot snapshot) {
        return new C00062(snapshot.getInputStream(ENTRY_BODY), snapshot);
    }
}
