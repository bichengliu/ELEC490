...
public class FileUtils extends CordovaPlugin {
    ...
    class C00924 implements FileOp {
        final /* synthetic */ CallbackContext val$callbackContext;
        final /* synthetic */ String val$fname;

        C00924(String str, CallbackContext callbackContext) {
            this.val$fname = str;
    ...
    class C00932 implements FileOp {
        final /* synthetic */ CallbackContext val$callbackContext;

        C00932(CallbackContext callbackContext) {
            this.val$callbackContext = callbackContext;
        }
    ...
    class AnonymousClass13 implements FileOp {
        ...
        AnonymousClass13(long j, CallbackContext callbackContext, int i) {
            this.val$size = j;
            this.val$callbackContext = callbackContext;
            this.val$fstype = i;
        }
    ...
    class C00948 implements FileOp {
        final /* synthetic */ CallbackContext val$callbackContext;
        final /* synthetic */ int val$end;
        final /* synthetic */ String val$fname;
        final /* synthetic */ int val$start;

        C00948(String str, int i, int i2, CallbackContext callbackContext) {
            this.val$fname = str;
            this.val$start = i;
            this.val$end = i2;
            this.val$callbackContext = callbackContext;
    ...
    class C00953 implements FileOp {
        final /* synthetic */ CallbackContext val$callbackContext;
        final /* synthetic */ String val$fname;

        C00953(String str, CallbackContext callbackContext) {
            this.val$fname = str;
            this.val$callbackContext = callbackContext;
        }
    ...
    class C00961 implements FileOp {
        final /* synthetic */ CallbackContext val$callbackContext;

        C00961(CallbackContext callbackContext) {
            this.val$callbackContext = callbackContext;
        }
    ...
    class C00976 implements FileOp {
        final /* synthetic */ CallbackContext val$callbackContext;
        final /* synthetic */ int val$end;
        final /* synthetic */ String val$fname;
        final /* synthetic */ int val$start;

        C00976(String str, int i, int i2, CallbackContext callbackContext) {
            this.val$fname = str;
            this.val$start = i;
            this.val$end = i2;
            this.val$callbackContext = callbackContext;
    ...
    class AnonymousClass18 implements FileOp {
        ...
        AnonymousClass18(String str, String str2, JSONArray jSONArray, CallbackContext callbackContext) {
            this.val$dirname = str;
            this.val$path = str2;
            this.val$args = jSONArray;
            this.val$callbackContext = callbackContext;
    ...
    class C00985 implements FileOp {
        final /* synthetic */ CallbackContext val$callbackContext;
        ...
        C00985(String str, int i, int i2, CallbackContext callbackContext, String str2) {
            this.val$fname = str;
            this.val$start = i;
            this.val$end = i2;
            this.val$callbackContext = callbackContext;
    ...
    class AnonymousClass20 implements FileOp {
        ...
        AnonymousClass20(String str, CallbackContext callbackContext) {
            this.val$fname = str;
            this.val$callbackContext = callbackContext;
        }
    ...
    class AnonymousClass24 implements FileOp {
        ...
        AnonymousClass24(String str, CallbackContext callbackContext) {
    ...
    class AnonymousClass25 implements Runnable {
        ...
        AnonymousClass25(FileOp fileOp, CallbackContext callbackContext) {
            this.val$f = fileOp;
            this.val$callbackContext = callbackContext;
        }
    ...
    class C00997 implements FileOp {
        final /* synthetic */ CallbackContext val$callbackContext;
        final /* synthetic */ int val$end;
        final /* synthetic */ String val$fname;
        final /* synthetic */ int val$start;

        C00997(String str, int i, int i2, CallbackContext callbackContext) {
            this.val$fname = str;
            this.val$start = i;
            this.val$end = i2;
            this.val$callbackContext = callbackContext;
    ...
    class AnonymousClass22 implements FileOp {
        ...
        AnonymousClass22(String str, String str2, String str3, CallbackContext callbackContext) {
            this.val$fname = str;
            this.val$newParent = str2;
            this.val$newName = str3;
            this.val$callbackContext = callbackContext;
    ...
    class C01009 implements FileOp {
        final /* synthetic */ CallbackContext val$callbackContext;
        ...
        C01009(String str, String str2, int i, Boolean bool, CallbackContext callbackContext) {
            this.val$fname = str;
            this.val$data = str2;
            this.val$offset = i;
    ...
    class AnonymousClass16 implements FileOp {
        ...
        AnonymousClass16(String str, CallbackContext callbackContext) {
            this.val$fname = str;
            this.val$callbackContext = callbackContext;
        }
            ...
            if (!installedFileSystems.contains(fsName)) {
                ...
                if (fsRoot != null) {
                    ...
                    if (newRoot.mkdirs() || newRoot.isDirectory()) {
                        registerFilesystem(new LocalFilesystem(fsName, this.cordova, Uri.fromFile(newRoot)));
    ...
    public void initialize(CordovaInterface cordova, CordovaWebView webView) {
        ...
        if (this.configured) {
            ...
            registerFilesystem(new ContentFilesystem(cordova, webView));
    ...
    public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
        if (this.configured) {
            if (action.equals("testSaveLocationExists")) {
                threadhelper(new C00961(callbackContext), callbackContext);
            } else {
                if (action.equals("getFreeDiskSpace")) {
                    threadhelper(new C00932(callbackContext), callbackContext);
                } else {
                    if (action.equals("testFileExists")) {
                        threadhelper(new C00953(args.getString(0), callbackContext), callbackContext);
                    } else {
                        if (action.equals("testDirectoryExists")) {
                            threadhelper(new C00924(args.getString(0), callbackContext), callbackContext);
                        } else {
                            if (action.equals("readAsText")) {
                                String encoding = args.getString(1);
                                threadhelper(new C00985(args.getString(0), args.getInt(2), args.getInt(3), callbackContext, encoding), callbackContext);
                            } else {
                                if (action.equals("readAsDataURL")) {
                                    threadhelper(new C00976(args.getString(0), args.getInt(1), args.getInt(2), callbackContext), callbackContext);
                                } else {
                                    if (action.equals("readAsArrayBuffer")) {
                                        threadhelper(new C00997(args.getString(0), args.getInt(1), args.getInt(2), callbackContext), callbackContext);
                                    } else {
                                        if (action.equals("readAsBinaryString")) {
                                            threadhelper(new C00948(args.getString(0), args.getInt(1), args.getInt(2), callbackContext), callbackContext);
                                        } else {
                                            if (action.equals("write")) {
                                                String string = args.getString(0);
                                                threadhelper(new C01009(fname, args.getString(1), args.getInt(2), Boolean.valueOf(args.getBoolean(3)), callbackContext), callbackContext);
                                            } else {
                                                    ...
                                                    if (action.equals("requestAllFileSystems")) {
                                                        ...
                                                        if (action.equals("requestAllPaths")) {
                                                            ...
                                                            if (action.equals("requestFileSystem")) {
                                                                threadhelper(new AnonymousClass13(args.optLong(1), callbackContext, args.getInt(0)), callbackContext);
                                                            } else {
                                                                if (action.equals("resolveLocalFileSystemURI")) {
                                                                    ...
                                                                    if (action.equals("getFileMetadata")) {
                                                                        ...
                                                                        if (action.equals("getParent")) {
                                                                            threadhelper(new AnonymousClass16(args.getString(0), callbackContext), callbackContext);
                                                                        } else {
                                                                            if (action.equals("getDirectory")) {
                                                                                ...
                                                                                if (action.equals("getFile")) {
                                                                                    threadhelper(new AnonymousClass18(args.getString(0), args.getString(1), args, callbackContext), callbackContext);
                                                                                } else {
                                                                                    if (action.equals("remove")) {
                                                                                        threadhelper(new AnonymousClass19(args.getString(0), callbackContext), callbackContext);
                                                                                    } else {
                                                                                        if (action.equals("removeRecursively")) {
                                                                                            threadhelper(new AnonymousClass20(args.getString(0), callbackContext), callbackContext);
                                                                                        } else {
                                                                                            String string2;
                                                                                            if (action.equals("moveTo")) {
                                                                                                ...
                                                                                                if (action.equals("copyTo")) {
                                                                                                    string2 = args.getString(0);
                                                                                                    threadhelper(new AnonymousClass22(fname, args.getString(1), args.getString(2), callbackContext), callbackContext);
                                                                                                } else {
                                                                                                    if (action.equals("readEntries")) {
                                                                                                        ...
                                                                                                        threadhelper(new AnonymousClass24(args.getString(0), callbackContext), callbackContext);
                                                                                                    }
                                                                                                }
                                                                                            }
                                                                                        }
    ...
    private void threadhelper(FileOp f, CallbackContext callbackContext) {
        this.cordova.getThreadPool().execute(new AnonymousClass25(f, callbackContext));
    }
