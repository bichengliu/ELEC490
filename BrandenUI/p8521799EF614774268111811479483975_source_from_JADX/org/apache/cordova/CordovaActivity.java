...
public class CordovaActivity extends Activity implements CordovaInterface {
    ...
    class C00363 implements Runnable {
        ...
        class C00671 implements OnClickListener {
            ...
            public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
                if (C00363.this.val$exit) {
                    C00363.this.val$me.endActivity();
                }
            }
        }

        C00363(CordovaActivity cordovaActivity, String str, String str2, String str3, boolean z) {
        ...
        public void run() {
            try {
                ...
                dlg.setPositiveButton(this.val$button, new C00671());
                dlg.create();
                dlg.show();
            } catch (Exception e) {
    ...
    class C00542 implements Runnable {
        ...
        C00542(boolean z, CordovaActivity cordovaActivity, String str, String str2) {
            this.val$exit = z;
            this.val$me = cordovaActivity;
    ...
    class C00691 implements Runnable {
        ...
        C00691(CordovaActivity cordovaActivity, String str) {
            this.val$me = cordovaActivity;
    ...
    public void onCreate(Bundle savedInstanceState) {
        LOG.m6i(TAG, "Apache Cordova native platform version 3.7.1 is starting");
    ...
    protected void createViews() {
        LOG.m0d(TAG, "CordovaActivity.createViews()");
        ...
        if (!(parent == null || parent == this.root)) {
            LOG.m0d(TAG, "removing appView from existing parent");
    ...
    public void init(CordovaWebView webView, CordovaWebViewClient webViewClient, CordovaChromeClient webChromeClient) {
        ...
        if (this.appView.pluginManager == null) {
            ...
            CordovaWebViewClient makeWebViewClient = webViewClient != null ? webViewClient : makeWebViewClient(this.appView);
            if (webChromeClient != null) {
                cordovaChromeClient = webChromeClient;
            } else {
                cordovaChromeClient = makeChromeClient(this.appView);
            }
            cordovaWebView.init(this, makeWebViewClient, cordovaChromeClient, this.pluginEntries, this.internalWhitelist, this.externalWhitelist, this.preferences);
        }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent intent) {
        ...
        LOG.m12w(TAG, "Got an activity result, but no plugin was registered to receive it.");
    }
    ...
    public void onReceivedError(int errorCode, String description, String failingUrl) {
        ...
        if (errorUrl == null || (!(errorUrl.startsWith("file://") || this.internalWhitelist.isUrlWhiteListed(errorUrl)) || failingUrl.equals(errorUrl))) {
            runOnUiThread(new C00542(errorCode != -2, me, description, failingUrl));
        } else {
            runOnUiThread(new C00691(me, errorUrl));
        }
    }

    public void displayError(String title, String message, String button, boolean exit) {
        runOnUiThread(new C00363(this, message, title, button, exit));
    }
