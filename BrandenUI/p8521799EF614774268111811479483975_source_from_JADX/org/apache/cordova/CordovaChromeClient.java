...
public class CordovaChromeClient extends WebChromeClient {
    ...
    class C00427 implements OnKeyListener {
        final /* synthetic */ JsResult val$result;

        C00427(JsResult jsResult) {
            this.val$result = jsResult;
        }
    ...
    class C00478 implements OnClickListener {
        final /* synthetic */ EditText val$input;
        final /* synthetic */ JsPromptResult val$res;

        C00478(EditText editText, JsPromptResult jsPromptResult) {
    ...
    class C00525 implements OnClickListener {
        final /* synthetic */ JsResult val$result;

        C00525(JsResult jsResult) {
            this.val$result = jsResult;
        }
    ...
    class C00563 implements OnKeyListener {
        final /* synthetic */ JsResult val$result;

        C00563(JsResult jsResult) {
            this.val$result = jsResult;
        }
    ...
    class C00612 implements OnCancelListener {
        final /* synthetic */ JsResult val$result;

        C00612(JsResult jsResult) {
            this.val$result = jsResult;
        }
    ...
    class C00656 implements OnCancelListener {
        final /* synthetic */ JsResult val$result;

        C00656(JsResult jsResult) {
            this.val$result = jsResult;
        }
    ...
    class C00719 implements OnClickListener {
        final /* synthetic */ JsPromptResult val$res;

        C00719(JsPromptResult jsPromptResult) {
            this.val$res = jsPromptResult;
        }
    ...
    public boolean onJsAlert(WebView view, String url, String message, JsResult result) {
        ...
        dlg.setPositiveButton(17039370, new C00371(result));
        dlg.setOnCancelListener(new C00612(result));
        dlg.setOnKeyListener(new C00563(result));
    ...
    public boolean onJsConfirm(WebView view, String url, String message, JsResult result) {
        ...
        dlg.setCancelable(true);
        dlg.setPositiveButton(17039370, new C00554(result));
        dlg.setNegativeButton(17039360, new C00525(result));
        dlg.setOnCancelListener(new C00656(result));
        dlg.setOnKeyListener(new C00427(result));
        this.lastHandledDialog = dlg.show();
        return true;
    }
    ...
    public boolean onJsPrompt(WebView view, String origin, String message, String defaultValue, JsPromptResult result) {
        ...
        if (handledRet != null) {
            ...
            dlg.setPositiveButton(17039370, new C00478(input, res));
            dlg.setNegativeButton(17039360, new C00719(res));
            this.lastHandledDialog = dlg.show();
        }
        return true;
    }
