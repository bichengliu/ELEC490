...
public class App extends CordovaPlugin {
    ...
    class C00483 implements Runnable {
        C00483() {
        }
    ...
    class C00575 extends BroadcastReceiver {
        C00575() {
        }
    ...
    public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
        ...
        try {
            if (action.equals("clearCache")) {
                ...
                this.cordova.getActivity().runOnUiThread(new C00681());
    ...
    public void clearCache() {
        this.cordova.getActivity().runOnUiThread(new C00662());
    }

    public void loadUrl(String url, JSONObject props) throws JSONException {
        LOG.m0d(PLUGIN_NAME, "App.loadUrl(" + url + "," + props + ")");
        int wait = 0;
    ...
    public void clearHistory() {
        this.cordova.getActivity().runOnUiThread(new C00483());
    }

    public void backHistory() {
        this.cordova.getActivity().runOnUiThread(new C00624());
    }

    public void overrideBackbutton(boolean override) {
        LOG.m6i(PLUGIN_NAME, "WARNING: Back Button Default Behavior will be overridden.  The backbutton event will be fired!");
        this.webView.setButtonPlumbedToJs(4, override);
    }

    public void overrideButton(String button, boolean override) {
        LOG.m6i(PLUGIN_NAME, "WARNING: Volume Button Default Behavior will be overridden.  The volume event will be fired!");
    ...
    private void initTelephonyReceiver() {
        ...
        this.telephonyReceiver = new C00575();
