...
public class Zip extends CordovaPlugin {
    ...
    class C00441 implements Runnable {
        ...
        C00441(CordovaArgs cordovaArgs, CallbackContext callbackContext) {
    ...
    private void unzip(CordovaArgs args, CallbackContext callbackContext) {
        this.cordova.getThreadPool().execute(new C00441(args, callbackContext));
    }
    ...
    private void unzipSync(CordovaArgs args, CallbackContext callbackContext) {
        ...
        outputDirectory = outputDirectory + (outputDirectory.endsWith(File.separator) ? "" : File.separator);
