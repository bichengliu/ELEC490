...
public class CordovaWebView extends WebView {
    ...
    class C00464 implements Runnable {
        final /* synthetic */ CordovaWebView val$me;
        final /* synthetic */ Runnable val$timeoutCheck;
        final /* synthetic */ String val$url;

        C00464(Runnable runnable, CordovaWebView cordovaWebView, String str) {
    ...
    class C00493 implements Runnable {
        ...
        C00493(int i, CordovaWebView cordovaWebView, int i2, Runnable runnable) {
    ...
    class C00602 implements Runnable {
        ...
        C00602(CordovaWebView cordovaWebView, String str) {
            this.val$me = cordovaWebView;
            this.val$url = str;
        }
    ...
    public void loadUrlIntoView(String url, boolean recreatePlugins) {
        ...
        this.cordova.getActivity().runOnUiThread(new C00464(new C00493(Integer.parseInt(getProperty("LoadUrlTimeoutValue", "20000")), this, currentLoadUrlTimeout, new C00602(this, url)), this, url));
    }
