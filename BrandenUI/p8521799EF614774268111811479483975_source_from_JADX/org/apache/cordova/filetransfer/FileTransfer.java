...
public class FileTransfer extends CordovaPlugin {
    ...
    class C01011 implements Runnable {
        ...
        C01011(RequestContext requestContext, CordovaResourceApi cordovaResourceApi, Uri uri, boolean z, boolean z2, String str, String str2, JSONObject jSONObject, JSONObject jSONObject2, String str3, String str4, String str5, Uri uri2, boolean z3, String str6, String str7) {
    ...
    class C01025 implements Runnable {
        ...
        C01025(RequestContext requestContext) {
            this.val$context = requestContext;
        }
    ...
    static class C01032 implements HostnameVerifier {
        C01032() {
        }
    ...
    class C01044 implements Runnable {
        ...
        C01044(RequestContext requestContext, CordovaResourceApi cordovaResourceApi, Uri uri, Uri uri2, boolean z, boolean z2, boolean z3, JSONObject jSONObject, String str, String str2, String str3) {
            this.val$context = requestContext;
            this.val$resourceApi = cordovaResourceApi;
            this.val$targetUri = uri;
            this.val$sourceUri = uri2;
    ...
    static class C01053 implements X509TrustManager {
        C01053() {
        }
    ...
    static {
        ...
        DO_NOT_VERIFY = new C01032();
        trustAllCerts = new TrustManager[]{new C01053()};
    }
    ...
    private void upload(String source, String target, JSONArray args, CallbackContext callbackContext) throws JSONException {
        ...
        if (uriType == 5 || useHttps) {
            ...
            this.cordova.getThreadPool().execute(new C01011(context, resourceApi, targetUri, useHttps, trustEveryone, httpMethod, target, headers, params, fileKey, fileName, mimeType, sourceUri, chunkedMode, source, objectId));
            return;
        }
    ...
    private void download(String source, String target, JSONArray args, CallbackContext callbackContext) throws JSONException {
        ...
        if (Boolean.TRUE.equals(shouldAllowRequest)) {
            ...
            this.cordova.getThreadPool().execute(new C01044(context, resourceApi, targetUri, sourceUri, isLocalTransfer, useHttps, trustEveryone, headers, source, target, objectId));
            return;
        }
    ...
    private void abort(String objectId) {
        ...
        if (context != null) {
            this.cordova.getThreadPool().execute(new C01025(context));
        }
    }
}
